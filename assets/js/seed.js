...
window.SEED = {
  ...
  tagGroups: [
    { name: "口味", emoji: "😋", tags: ["甜", "酸", "苦", "涩", "咸", "辣", "果香", "奶香", "咖啡", "草本", "烟熏", "清爽"] },
    { name: "口感", emoji: "🫧", tags: ["气泡", "浓郁", "绵密", "冰沙"] },
    { name: "长度", emoji: "⏳", tags: ["长饮", "短饮"] },
    { name: "酒感", emoji: "🥴", tags: ["无酒精", "微醺", "中等", "烈"] },
    { name: "场合", emoji: "🎉", tags: ["餐前", "餐后", "派对", "独饮", "夏日", "冬日"] }
  ],
